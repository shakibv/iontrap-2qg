...
#include <differential-evolution/de_types.hpp>
#include <differential-evolution/processors.hpp>
 ...
 */
        ...
        public:
             ...
             */
            virtual double operator()(amichel::de::DVectorPtr args, int genCount) = 0;
